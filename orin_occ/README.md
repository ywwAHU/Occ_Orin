...
This project is a clean OCC baseline tailored for the current vehicle setup:

- 3 front cameras
- 3 rear low-light cameras
- 4 surround cameras
...
- It assumes 10 cameras as the main sensing backbone.
- It keeps lidar as an enhancement path, which matches the current multi-lidar vehicle while still keeping the first deployment baseline simple.
...
2. Improve the projector using your exact camera models and image preprocessing.
